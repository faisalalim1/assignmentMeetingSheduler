...
function Main() {
  ...
  const handelChange = (e) => {
      ...
      if(name == "startTime" && value  < "09:00" ){
        alert("kindly book between 09:00AM-05:30PM")
       }
       if(name == "finishTime" && value > "17:30"){
        alert("kindly book between 09:00AM-05:30PM")
    ...
    <div className="app">
      <div className="container">
        ...
        <div className="calendar-container">
          ...
          <input className="input"  type="date" id="birthday" name="date" value={meet.date} onChange={handelChange}></input>
        </div>
